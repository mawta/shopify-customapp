...
const { Option } = Select;
const { TabPane } = Tabs;
export class PriceRule extends Component {
    constructor(props) {
        super(props);
        this.state = {
            current: 1,
            ...
            radioValue2: "tag",
            limit: 1,
            productRuleDiscount: 1,
            productRuleCollectionId: "all",
            productRuleCollectionIdDiscount: "all",
            discount: 5,
            discountType: 1,
        };
    }
                                        ...
                                        <Col span="24">
                                            <Select
                                                ...
                                                onChange={(key) => {
                                                    ...
                                                    if (
                                                        !listProductSelect.includes(
                                                            temp
                                                        )
                                                    ) {
                                                        listProductSelect.push(
                                                            temp
                                                        );
                                                    }
                                                    this.setState({
                                    ...
                                    <Row gutter={[12, 12]}>
                                        <Col span="24">
                                            <Select
                                                ...
                                                onChange={(key) => {
                                                    ...
                                                    if (!listProductDiscount) {
                                                        listProductDiscount =
                                                            [];
                                                    }

                                                    if (
                                                        !listProductDiscount.includes(
                                                            temp
                                                        )
                                                    ) {
                                                        listProductDiscount.push(
                                                            temp
                                                        );
                                                    }
                                                    this.setState({
                                        ...
                                        <Col span="24">
                                            <List
                                                className="demo-loadmore-list"
                                                itemLayout="horizontal"
                                                dataSource={listProductDiscount}
                                                renderItem={(item) => (
                                                    <List.Item
                                                        actions={[
                                                            <a
